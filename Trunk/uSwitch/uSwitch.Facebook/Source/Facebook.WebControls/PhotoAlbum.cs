...
namespace Facebook.WebControls
{
    ...
    public class PhotoAlbum : WebControl, IPostBackEventHandler
    {
        ...
        private const int MAX_ALBUM_LENGTH = 25;
        ...
        protected override void RenderContents(HtmlTextWriter output)
        {
            ...
            if (!Equals(_photos, null))
            {
                ...
                output.AddAttribute(HtmlTextWriterAttribute.Onchange, "javascript:__doPostBack('MyPhotoAlbum','album' + document.form1.albumList.selectedIndex)");
                ...
                for (int x=0;x<_albums.Count;x++)
                {
                    ...
                    if (_albums[x].Name.Length > MAX_ALBUM_LENGTH)
                    {
                        output.Write(_albums[x].Name.Substring(0, MAX_ALBUM_LENGTH));
                    }
                    else
                    {
                ...
                //Previous link
                output.AddAttribute(HtmlTextWriterAttribute.Href, Page.ClientScript.GetPostBackClientHyperlink(this, PHOTO_NAV_PREVIOUS));
        ...
        private void LoadFromViewState()
        {
            ...
            {
                _photos = (Collection<Photo>)photos;
            }

            object albums = ViewState[VIEWSTATE_ALBUMS];
            if (!Equals(albums, null))
            {
                _albums = (Collection<Album>)albums;
            }
        ...
        /// <summary>
        /// An insance of the Facebook service.  We use this to look up the albums and photos. 
        /// </summary>
        ...
        {
            if (Equals(_facebookService, null))
            {
            ...
            {
                Albums = _facebookService.GetPhotoAlbums(_userId);
                ResetAlbumIndex();
                LoadPhotos();
            }
        }
        ...
        private string GetImageUri(int index)
        {
            ...
            {
                return _photos[index].PictureUrl.ToString();
            }
            return string.Empty;
        }
        ...
        private Collection<Album> Albums
        {
            set
            {
                ...
                if (UseViewState)
                {
                    ViewState[VIEWSTATE_ALBUMS] = value;
                }
            }
        }
        private Collection<Photo> Photos
        {
            set
            {
                ...
                if (UseViewState)
                {
                    ViewState[VIEWSTATE_PHOTOS] = value;
                }
                ResetImageIndex();
            }
        }
