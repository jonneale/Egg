    ...
    public partial class PhotoAlbum : BaseControl
    {
        ...
        private void LoadImage(int index)
        {
            ...
            else
            {
                ...
                {
                    if (_photos[index].PictureUrl != null)
                    {
                        pbPhoto.ImageLocation = _photos[index].PictureUrl.ToString();
                    }
                    else
                    {
        ...
        private void SaveImages()
        {
            foreach (Photo photo in _photos)
            {
                ...
                Bitmap bitmap = new Bitmap(photo.Picture);
                bitmap.Save(Path.Combine(_selectedPath, photo.PhotoId + ".jpg"), ImageFormat.Jpeg);
            }
        }
