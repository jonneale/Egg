...
namespace uSwitch.SiteSpeed.Web.Core.Modules
{
	public class CacheModule : IHttpModule
	{
		...
		void context_PostRequestHandlerExecute(object sender, EventArgs e)
		{
            ...
            if (extensions.ToLowerInvariant().Contains("css")
                || extensions.ToLowerInvariant().Contains("js")
                || extensions.ToLowerInvariant().Contains("jpg")
                || extensions.ToLowerInvariant().Contains("gif"))
            {
