...
{
    public class CreateEventViewDataBinder : System.Web.Mvc.DefaultModelBinder
    {
        ...
        {
            var eventView =
                base.CreateModel(controllerContext, bindingContext, modelType) as CreateEventView;
